...
public class Tab04 extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
       ...
       from_adapter.setDropDownViewResource(android.R.layout.simple_dropdown_item_1line);
        ...
        Spinner to_dropdown = (Spinner) rootView.findViewById(R.id.to_spinner);
        ...
        Spinner interval_dropdown = (Spinner) rootView.findViewById(R.id.interval_spinner);
        ...
        Spinner sound_dropdown = (Spinner) rootView.findViewById(R.id.sound_spinner);
        ...
        Spinner vibration_dropdown = (Spinner) rootView.findViewById(R.id.vibration_spinner);
